...
SELF_UPGRADE = bool(os.environ.get('PYPLANET_SELF_UPGRADE', False))
...
DEDICATED = {
	'default': {
		'HOST': str(os.environ.get("RPC_IP", "dedicated")),
...
BLACKLIST_FILE = {
	'default': str(os.environ.get("PYPLANET_BLACKLIST", "blacklist.txt")),
}
